...
public class RenameMethodTests extends TestCase {
    ...
    public void test41() {
    	testSucc(
    		...
    		"package a;" + 
    		"public class A {" +
    		"  int n(int i) { return 10; }" +
    		"  public int m(long l) { return 20; }" +
    		"  public int test() { return n(2); }" +
    		"}"), new RawCU("B.java",
    		"package b;" +
    		"import a.*;" +
    ...
    public void test42() {
    	testSucc(
    		...
    		Program.fromClasses(
    		"public class A {" +
    		"  public int k(long l) { return 10; }" +
    		"  public int test() { return k(2); }" +    		
    		"}",
    		"public class B extends A {" +
    		"  public int n(int i) { return 20; }" +
    		"}"),
    		Program.fromClasses(
    				"public class A {" +
    	    		"  public int n(long l) { return 10; }" +
    	    		"  public int test() { return n(2); }" +    		
    	    		"}",
    	    		"public class B extends A {" +
    	    		"  public int n(int i) { return 20; }" +
    ...
    public void test43() {
    	testFail("Class2_0", "k_0(long)", "n",Program.fromCompilationUnits(
    			 new RawCU("Class1_0.java",
    			 "package P1_0;" +
    			 "import P2_0.*;" +
    			 "public class Class1_0 extends Class2_0 {" +
    			 "  public long m_0(){return new Class2_0().k_0(2);}" +
    			 "}")    			
    			,new RawCU("Class2_0.java",
    			"package P2_0;" +
    			"public class Class2_0 {" +
    			"  public long k_0(long a){ return 2;}" +
    			"  protected long k_0(int a){ return 10;}" +
    			"}")));
    }
