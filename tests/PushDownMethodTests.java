...
public class PushDownMethodTests extends TestCase {
    ...
    public void test39() {
    	testFail(Program.fromCompilationUnits(
    			 ...
    			 "  public long m_0(){return new Class1_0().k_0(2);}" +
    			 "  protected long k_0(  int a){ return 1;}" +
    			 "}"),
    			...
    			"  protected long k_0(  long a){ return 2;}" +
    			"  public long test_0(){ return m_0();}" +
    			"}")));
    }
    ...
    public void test40() {
    	testFail(Program.fromCompilationUnits(
    			...
    			"package P1_0;" +
    			"public class Class2_0 extends Class1_0 {" +
    			"  protected long k_0(  int a){ return 2;}" +
    			"  public long test_0(){ return m_0();}" +
    			"}")));
    }
