...
public class CompileHelper {
	...
	public static Program compile2(String... files) throws CompilerErrorException {
		List<String> sources = new LinkedList<String>();
		List<String> jars = new LinkedList<String>();
		for (String n : files)
			if (n.endsWith(".jar"))
		...
		CompilerErrorException e = new CompilerErrorException();
		e.setErrors(f.getCompilationErrors());
		throw e;
