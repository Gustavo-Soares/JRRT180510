...
public class WildcardExtendsType extends AbstractWildcardType implements Cloneable {
  ...
  public Access substitute(Parameterization parTypeDecl) {
    ...
    // Declared in LockedTypeAccess.jrag at line 77
...
if(instanceOf_TypeDecl_values == null) instanceOf_TypeDecl_values = new java.util.HashMap(4);
    ...
    // Declared in Refresh.jrag at line 35
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {  return programRoot().wildcards().lookupWildcardExtends(getAccess().type().refresh());  }
