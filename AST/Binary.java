...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public CFGNode first() {
    ...
    private CFGNode first_compute() {  return getLeftOperand().first();  }

    // Declared in Purity.jrag at line 23
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPure() {
    ...
    private boolean isPure_compute() {  return getLeftOperand().isPure() && getRightOperand().isPure();  }
...
if(isDUbefore_Variable_values == null) isDUbefore_Variable_values = new java.util.HashMap(4);
    ...
    // Declared in ControlFlowGraph.jrag at line 199
    ...
    // Declared in Precedence.jrag at line 82
