...
public class ClassDeclSubstituted extends ClassDecl implements Cloneable, MemberSubstitutor, TypeDeclSubstituted {
    ...
    // Declared in MakeTypeAbstract.jrag at line 9
...
if(localTypeDecls_String_values == null) localTypeDecls_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Collection constructors() {
    ...
    // Declared in Refresh.jrag at line 37
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {
