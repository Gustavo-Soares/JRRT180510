...
if(typeArguments_MethodDecl_values == null) typeArguments_MethodDecl_values = new java.util.HashMap(4);
    ...
    // Declared in BareParMethodAccess.jrag at line 2
 @SuppressWarnings({"unchecked", "cast"})     public boolean isBare() {
        ASTNode$State state = state();
        boolean isBare_value = isBare_compute();
        return isBare_value;
    }

    private boolean isBare_compute() {  return !isQualified();  }
