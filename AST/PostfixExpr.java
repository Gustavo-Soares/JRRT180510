...
public abstract class PostfixExpr extends Unary implements Cloneable {
  ...
  protected int numChildren() {
    ...
    // Declared in ExprExt.jrag at line 6
 @SuppressWarnings({"unchecked", "cast"})     public boolean isStatementExpression() {
    ...
    // Declared in Precedence.jrag at line 11
 @SuppressWarnings({"unchecked", "cast"})     public int precedence() {
    ...
    private int precedence_compute() {  return 2;  }

    // Declared in Purity.jrag at line 32
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPure() {
    ...
    // Declared in ControlFlowGraph.jrag at line 185
    ...
    // Declared in ExprExt.jrag at line 34
