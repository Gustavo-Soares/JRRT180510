...
public class InterfaceDecl extends ReferenceType implements Cloneable {
  ...
  public InterfaceDecl p(Parameterization parTypeDecl) {
    ...
    // Declared in Inheritance.jrag at line 21
            ...
            if(isFinal && num == state().boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean supertypeArrayDecl(ArrayDecl type) {
    ...
    // Declared in AccessMethod.jrag at line 130
 @SuppressWarnings({"unchecked", "cast"})     public MethodAccessInfo accessMemberMethod(MethodDecl md) {
    ...
    // Declared in AccessVariable.jrag at line 326
...
public ASTNode rewriteTo() {
    ...
    protected void collect_contributors_TypeDecl_childTypes() {
        // Declared in Inheritance.jrag at line 11
