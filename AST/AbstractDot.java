...
public class AbstractDot extends Access implements Cloneable {
  ...
  public void replaceLast(Access access) {
    ...
    // Declared in AST.jrag at line 111
    ...
    // Declared in With.jrag at line 148
    ...
    // Declared in Locking.jrag at line 44

	
	public ASTNode eliminateLockedNames() {
...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean staticContextQualifier() {
    ...
    // Declared in Alias.jrag at line 15
 @SuppressWarnings({"unchecked", "cast"})     public Location getLocation() {
    ...
    // Declared in Alias.jrag at line 32
 @SuppressWarnings({"unchecked", "cast"})     public boolean mayReferTo(Location l) {
    ...
    private boolean mayReferTo_compute(Location l) {  return getRight().mayReferTo(l);  }

    // Declared in Alias.jrag at line 37
 @SuppressWarnings({"unchecked", "cast"})     public boolean mustReferTo(Location l) {
    ...
    private boolean mustReferTo_compute(Location l) {  return getRight().mustReferTo(l);  }

    // Declared in ControlFlowGraph.jrag at line 287
 @SuppressWarnings({"unchecked", "cast"})     public CFGNode first() {
    ...
    private CFGNode first_compute() {  return getLeft().first();  }

    // Declared in ExprExt.jrag at line 9
 @SuppressWarnings({"unchecked", "cast"})     public boolean isStatementExpression() {
    ...
    private boolean isStatementExpression_compute() {  return getRight().isStatementExpression();  }

    // Declared in ExprExt.jrag at line 16
 @SuppressWarnings({"unchecked", "cast"})     public boolean notAnObject() {
    ...
    private boolean notAnObject_compute() {  return super.notAnObject() || !isArrayAccess() && !isClassAccess() && getRight().notAnObject();  }

    // Declared in ExprExt.jrag at line 81
 @SuppressWarnings({"unchecked", "cast"})     public Expr convertSuperToThis() {
    ...
    private Expr convertSuperToThis_compute() {  return new AbstractDot(getLeft().convertSuperToThis(), 
														  (Access)getRight().convertSuperToThis());  }

    // Declared in Purity.jrag at line 5
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPure() {
    ...
    private boolean isPure_compute() {  return getLeft().isPure() && getRight().isPure();  }

    // Declared in VariableExt.jrag at line 44
 @SuppressWarnings({"unchecked", "cast"})     public boolean isFieldAccessInThis(FieldDeclaration fd) {
    ...
    private boolean isFieldAccessInThis_compute(FieldDeclaration fd) {  return getLeft().isThisAccess() && getRight().isFieldAccessInThis(fd);  }

    // Declared in MakeConversionExplicit.jrag at line 9
...
if(isDUbefore_Variable_values == null) isDUbefore_Variable_values = new java.util.HashMap(4);
    ...
    // Declared in ExprExt.jrag at line 35
    ...
    // Declared in Precedence.jrag at line 64
    ...
    // Declared in AccessMethod.jrag at line 106
    ...
    // Declared in AccessVariable.jrag at line 257
