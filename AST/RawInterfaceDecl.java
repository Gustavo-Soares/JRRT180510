...
public class RawInterfaceDecl extends ParInterfaceDecl implements Cloneable {
  ...
  public Access substituteParameterType(Parameterization parTypeDecl) { return createBoundAccess(); }
    ...
    // Declared in LockedTypeAccess.jrag at line 67
...
if(instanceOf_TypeDecl_values == null) instanceOf_TypeDecl_values = new java.util.HashMap(4);
    ...
    // Declared in Refresh.jrag at line 33
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {  return ((GenericTypeDecl)genericDecl().refresh()).rawType();  }
