...
public class WildcardSuperType extends AbstractWildcardType implements Cloneable {
  ...
  public Access substitute(Parameterization parTypeDecl) {
    ...
    // Declared in LockedTypeAccess.jrag at line 81
...
if(instanceOf_TypeDecl_values == null) instanceOf_TypeDecl_values = new java.util.HashMap(4);
    ...
    // Declared in Refresh.jrag at line 36
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {  return programRoot().wildcards().lookupWildcardSuper(getAccess().type().refresh());  }
