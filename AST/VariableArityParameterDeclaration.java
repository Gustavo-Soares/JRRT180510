...
*/
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in ParameterExt.jrag at line 2
    ...
    // Declared in ParameterExt.jrag at line 12

	
	public ParameterDeclaration lockedCopy() {
		return new VariableArityParameterDeclaration((Modifiers)getModifiers().fullCopy(), getTypeAccess().type().createLockedAccess(), name());
	}
