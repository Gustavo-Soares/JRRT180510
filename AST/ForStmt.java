...
if(localVariableDeclaration_String_values == null) localVariableDeclaration_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 450
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet<CFGNode> succ() {
    ...
    // Declared in ControlFlowGraph.jrag at line 755
 @SuppressWarnings({"unchecked", "cast"})     public CFGNode targetForContinue() {
    ...
    private CFGNode targetForContinue_compute() {  return getNumUpdateStmt() > 0 ? getUpdateStmt(0) : (hasCondition() ? getCondition().first() : getStmt());  }

    // Declared in AccessVariable.jrag at line 28
 @SuppressWarnings({"unchecked", "cast"})     public boolean hasVariable(String name) {
    ...
    private boolean hasVariable_compute(String name) {  return localVariableDeclaration(name) != null;  }

    // Declared in AccessVariable.jrag at line 219
 @SuppressWarnings({"unchecked", "cast"})     public SymbolicVarAccess localAccess(Variable decl) {
        ASTNode$State state = state();
        SymbolicVarAccess localAccess_Variable_value = localAccess_compute(decl);
        return localAccess_Variable_value;
    }

    private SymbolicVarAccess localAccess_compute(Variable decl) {
    ...
    // Declared in AccessVariable.jrag at line 243
 @SuppressWarnings({"unchecked", "cast"})     public SymbolicVarAccess accessLocalVariable(Variable decl) {
...
if(accessLocalVariable_Variable_values == null) accessLocalVariable_Variable_values = new java.util.HashMap(4);
        ...
        if(isFinal && num == state().boundariesCrossed)
            accessLocalVariable_Variable_values.put(_parameters, accessLocalVariable_Variable_value);
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
    ...
    // Declared in AccessVariable.jrag at line 136
   ...
   int i = caller.getIndexOfChild(child);
{
    ...
    // Declared in ControlFlowGraph.jrag at line 459
    ...
    // Declared in ControlFlowGraph.jrag at line 454
    ...
    // Declared in ControlFlowGraph.jrag at line 455
    ...
    // Declared in Precedence.jrag at line 72
    ...
    // Declared in AccessVariable.jrag at line 216
    ...
    // Declared in RenameVariable.jrag at line 42
    ...
    // Declared in DeleteStmt.jrag at line 14
...
{ getInitStmtList().removeChild(i); return true; }
    ...
    // Declared in InsertEmptyStmt.jrag at line 42
    ...
    // Declared in InsertEmptyStmt.jrag at line 99
