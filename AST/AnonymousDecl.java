...
public class AnonymousDecl extends ClassDecl implements Cloneable {
    ...
    // Declared in TypeExt.jrag at line 6

	
	public ClassDecl asNamedClass(String name) {
    ...
    // Declared in LockedTypeAccess.jrag at line 7

	public boolean hasName() { return false; }

    // Declared in MakeTypeAbstract.jrag at line 3

	public void makeAbstract() { throw new RefactoringException("type cannot be made abstract"); }

    // Declared in AnonymousClassToLocalClass.jrag at line 2
    ...
    // Declared in AnonymousClassToLocalClass.jrag at line 27
    ...
    // Declared in AnonymousClassToLocalClass.jrag at line 34
    ...
    // Declared in AnonymousClassToMemberClass.jrag at line 2
	...
	public MemberTypeDecl doPromoteToMemberClass(String className, boolean makeFinal, boolean makePublic) {
		...
		if(bd instanceof FieldDeclaration) {
			ClassInstanceExpr cie = (ClassInstanceExpr)getParent().getParent();
			lockAllNames();
			ClassDecl cd = asNamedClass(className);
			if(!makeFinal)
				cd.getModifiers().removeModifier("final");
			cd.getModifiers().setVisibility(makePublic ? VIS_PUBLIC : VIS_PRIVATE);
