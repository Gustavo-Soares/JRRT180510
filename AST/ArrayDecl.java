...
public class ArrayDecl extends ClassDecl implements Cloneable {
  ...
  public Access substituteReturnType(Parameterization parTypeDecl) {
    ...
    // Declared in LockedTypeAccess.jrag at line 39
    ...
    // Declared in MakeTypeAbstract.jrag at line 4
            ...
            if(isFinal && num == state().boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean supertypeArrayDecl(ArrayDecl type) {
    ...
    // Declared in Refresh.jrag at line 25
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {  return componentType().refresh().arrayType();  }
