...
public abstract class TypeDecl extends ASTNode<ASTNode> implements Cloneable, SimpleSet, Iterator, VariableScope, Declaration, Visible, Scope {
    ...
    collect_contributors_Definition_reachedUses = false;
  ...
  public Access substituteParameterType(Parameterization parTypeDecl) {
    ...
    // Declared in AST.jrag at line 60
    ...
    // Declared in ExprExt.jrag at line 69
    ...
    // Declared in Nesting.jrag at line 11
    ...
    // Declared in Refresh.jrag at line 21
    ...
    // Declared in TypeExt.jrag at line 73
    ...
    // Declared in InsertUnusedType.jrag at line 3
    ...
    // Declared in InsertUnusedType.jrag at line 6
    ...
    // Declared in InsertUnusedType.jrag at line 15
    ...
    // Declared in FreshVariables.jrag at line 169

	public void freshenAllLocalDeclarations() { }

    // Declared in With.jrag at line 107
    ...
    // Declared in InsertUnusedMethod.jrag at line 3
    ...
    // Declared in InsertUnusedMethod.jrag at line 6
    ...
    // Declared in MoveMembers.jrag at line 2
    ...
    // Declared in MoveMembers.jrag at line 12
    ...
    // Declared in AccessMethod.jrag at line 59
    ...
    // Declared in AccessMethod.jrag at line 146
    ...
    // Declared in LockedTypeAccess.jrag at line 3

	// not all types have a name
	public boolean hasName() { return true; }

    // Declared in LockedTypeAccess.jrag at line 33
    ...
    // Declared in VarNesting.jrag at line 36
    ...
    // Declared in InsertField.jrag at line 2

	public void insertField(FieldDeclaration fd) {
		insertField(fd, null);
	}

    // Declared in InsertField.jrag at line 6
    ...
    // Declared in AddRequiredMembers.jrag at line 2
    ...
    // Declared in PullUpMembers.jrag at line 2
    ...
    // Declared in PullUpMembers.jrag at line 15
    ...
    // Declared in MakeTypeAbstract.jrag at line 2

	public void makeAbstract() { throw new RefactoringException("type cannot be made abstract"); }

    // Declared in PushDownMethod.jrag at line 53
    ...
    // Declared in RenameMethod.jrag at line 31
    ...
    // Declared in RenameMethod.jrag at line 35
    ...
    // Declared in RenameType.jrag at line 7
    ...
    // Declared in RenameType.jrag at line 20
    ...
    // Declared in RenameType.jrag at line 59
    ...
    // Declared in MoveMemberTypeToToplevel.jrag at line 31
    ...
    // Declared in MoveMemberTypeToToplevel.jrag at line 43
    ...
    // Declared in MoveMemberTypeToToplevel.jrag at line 88
    ...
    // Declared in Testing.jrag at line 177
  ...
  protected int numChildren() {
    ...
    // Declared in Testing.jrag at line 36
...
{ return identityConversionTo(type) ||
    ...
    private boolean collect_contributors_Definition_reachedUses = false;
    protected void collect_contributors_Definition_reachedUses() {
        if(collect_contributors_Definition_reachedUses) return;
        super.collect_contributors_Definition_reachedUses();
        collect_contributors_Definition_reachedUses = true;
    }
            ...
            if(isFinal && num == state().boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public BodyDecl getFieldOrInitializerAfter(int i, boolean statik) {
        ASTNode$State state = state();
        BodyDecl getFieldOrInitializerAfter_int_boolean_value = getFieldOrInitializerAfter_compute(i, statik);
        return getFieldOrInitializerAfter_int_boolean_value;
    }

    private BodyDecl getFieldOrInitializerAfter_compute(int i, boolean statik) {
    ...
    // Declared in Exceptions.jrag at line 53
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet<TypeDecl> uncaughtExceptions() {
    ...
    // Declared in DefaultValues.jrag at line 2
 @SuppressWarnings({"unchecked", "cast"})     public Expr defaultValue() {
    ...
    private Expr defaultValue_compute() {  return new NullLiteral("null");  }

    protected java.util.Map overrides_MethodDecl_values;
    // Declared in MethodExt.jrag at line 54
 @SuppressWarnings({"unchecked", "cast"})     public boolean overrides(MethodDecl md) {
...
if(overrides_MethodDecl_values == null) overrides_MethodDecl_values = new java.util.HashMap(4);
    ...
    // Declared in MethodExt.jrag at line 100
...
if(descendantMethods_String_values == null) descendantMethods_String_values = new java.util.HashMap(4);
    ...
    protected java.util.Map rootdef_String_boolean_values;
    // Declared in MethodExt.jrag at line 128
...
if(rootdef_String_boolean_values == null) rootdef_String_boolean_values = new java.util.HashMap(4);
    ...
    private MethodDecl rootdef_compute(String sig, boolean isPkg) {  return null;  }

    // Declared in Refresh.jrag at line 24
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
        ASTNode$State state = state();
        TypeDecl refreshType_value = refreshType_compute();
        return refreshType_value;
    }

    private TypeDecl refreshType_compute() {  return this;  }

    protected boolean instancesAreConstructed_computed = false;
    protected boolean instancesAreConstructed_value;
    // Declared in TypeExt.jrag at line 53
 @SuppressWarnings({"unchecked", "cast"})     public boolean instancesAreConstructed() {
    ...
    // Declared in AccessMethod.jrag at line 83
 @SuppressWarnings({"unchecked", "cast"})     public MethodAccessInfo unqualifiedAccessMethod(MethodDecl md) {
        ASTNode$State state = state();
        MethodAccessInfo unqualifiedAccessMethod_MethodDecl_value = unqualifiedAccessMethod_compute(md);
        return unqualifiedAccessMethod_MethodDecl_value;
    }

    private MethodAccessInfo unqualifiedAccessMethod_compute(MethodDecl md) {
    ...
    // Declared in AccessMethod.jrag at line 110
 @SuppressWarnings({"unchecked", "cast"})     public MethodAccessInfo accessMemberMethod(MethodDecl md) {
    ...
    private MethodAccessInfo accessMemberMethod_compute(MethodDecl md) {  return accessLocalMethod(md);  }

    // Declared in AccessVariable.jrag at line 25
 @SuppressWarnings({"unchecked", "cast"})     public boolean hasVariable(String name) {
    ...
    private boolean hasVariable_compute(String name) {  return !memberFields(name).isEmpty();  }

    // Declared in AccessVariable.jrag at line 124
 @SuppressWarnings({"unchecked", "cast"})     public boolean sameSourceDeclAs(TypeDecl decl) {
        ASTNode$State state = state();
        boolean sameSourceDeclAs_TypeDecl_value = sameSourceDeclAs_compute(decl);
        return sameSourceDeclAs_TypeDecl_value;
    }

    private boolean sameSourceDeclAs_compute(TypeDecl decl) {  return sourceTypeDecl().equals(decl.sourceTypeDecl());  }

    // Declared in AccessVariable.jrag at line 284
 @SuppressWarnings({"unchecked", "cast"})     public SymbolicFieldAccess accessMemberField(Variable decl) {
        ASTNode$State state = state();
        SymbolicFieldAccess accessMemberField_Variable_value = accessMemberField_compute(decl);
        return accessMemberField_Variable_value;
    }

    private SymbolicFieldAccess accessMemberField_compute(Variable decl) {  return accessField(decl);  }

    // Declared in AccessVariable.jrag at line 288
 @SuppressWarnings({"unchecked", "cast"})     public SymbolicFieldAccess accessLocalField(Variable decl) {
        ASTNode$State state = state();
        SymbolicFieldAccess accessLocalField_Variable_value = accessLocalField_compute(decl);
        return accessLocalField_Variable_value;
    }

    private SymbolicFieldAccess accessLocalField_compute(Variable decl) {
    ...
    // Declared in AccessVariable.jrag at line 298
 @SuppressWarnings({"unchecked", "cast"})     public SymbolicFieldAccess accessField(Variable decl) {
    ...
    private SymbolicFieldAccess accessField_compute(Variable decl) {  return accessLocalField(decl);  }

    // Declared in AccessVariable.jrag at line 301
 @SuppressWarnings({"unchecked", "cast"})     public boolean canInherit(Variable v) {
        ASTNode$State state = state();
        boolean canInherit_Variable_value = canInherit_compute(v);
        return canInherit_Variable_value;
    }

    private boolean canInherit_compute(Variable v) {
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public GLBType lookupGLBType(ArrayList bounds) {
    ...
    // Declared in AccessMethod.jrag at line 71
 @SuppressWarnings({"unchecked", "cast"})     public MethodAccessInfo accessMethod(MethodDecl md) {
    ...
    // Declared in AccessVariable.jrag at line 116
 @SuppressWarnings({"unchecked", "cast"})     public UnknownVarAccess unknownVarAccess() {
    ...
    // Declared in AccessVariable.jrag at line 132
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in ControlFlowGraph.jrag at line 53
    ...
    // Declared in ControlFlowGraph.jrag at line 663
    ...
    // Declared in ControlFlowGraph.jrag at line 664
    ...
    // Declared in ControlFlowGraph.jrag at line 665
    ...
    // Declared in ControlFlowGraph.jrag at line 666
    ...
    // Declared in ControlFlowGraph.jrag at line 667
    ...
    // Declared in LocalVariable.jrag at line 14
    ...
    // Declared in ModifiersExt.jrag at line 5
    ...
    // Declared in TypeAccessExt.jrag at line 4
    ...
    // Declared in AccessMethod.jrag at line 80
    ...
    // Declared in AccessVariable.jrag at line 144
   ...
   int i = caller.getIndexOfChild(child);
{
    ...
    // Declared in InsertEmptyStmt.jrag at line 17
...
{ throw new RefactoringException("cannot insert statement here"); }
    ...
    // Declared in InsertEmptyStmt.jrag at line 63
...
public ASTNode rewriteTo() {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Collection<TypeDecl> childTypes() {
            ...
            if(isFinal && num == state().boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Collection<Access> instantiations() {
        ...
        if(isFinal && num == state().boundariesCrossed)
            TypeDecl_instantiations_computed = true;
        return TypeDecl_instantiations_value;
    }
    ...
    protected void collect_contributors_Program_typeWithSameNameAsPackage() {
        // Declared in RenamePackage.jrag at line 41
