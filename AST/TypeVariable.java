...
public class TypeVariable extends ReferenceType implements Cloneable {
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in TypeVariableExt.jrag at line 2
    ...
    // Declared in TypeVariableExt.jrag at line 118
    ...
    // Declared in RenameType.jrag at line 42
...
if(instanceOf_TypeDecl_values == null) instanceOf_TypeDecl_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl typeNull() {
    ...
    // Declared in TypeVariableExt.jrag at line 18
 @SuppressWarnings({"unchecked", "cast"})     public GenericElement owner() {
        ASTNode$State state = state();
