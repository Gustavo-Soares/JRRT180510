...
public class WildcardType extends AbstractWildcardType implements Cloneable {
    ...
    // Declared in LockedTypeAccess.jrag at line 73
...
if(instanceOf_TypeDecl_values == null) instanceOf_TypeDecl_values = new java.util.HashMap(4);
    ...
    // Declared in Refresh.jrag at line 34
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl refreshType() {
    ...
    private TypeDecl refreshType_compute() {  return programRoot().wildcards().typeWildcard();  }
