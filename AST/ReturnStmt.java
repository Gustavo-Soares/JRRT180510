...
public class ReturnStmt extends Stmt implements Cloneable {
  ...
  public void typeCheck() {
    ...
    // Declared in IntroduceOutParameter.jrag at line 35
...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 525
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet<CFGNode> succ() {
    ...
    // Declared in ControlFlowGraph.jrag at line 576
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet<CFGNode> collectBranches() {
    ...
    private SmallSet<CFGNode> collectBranches_compute() {  return SmallSet.<CFGNode>singleton(this);  }

    // Declared in ReturnVoid.jrag at line 2
 @SuppressWarnings({"unchecked", "cast"})     public boolean returnsVoid() {
        ASTNode$State state = state();
        boolean returnsVoid_value = returnsVoid_compute();
        return returnsVoid_value;
    }

    private boolean returnsVoid_compute() {  return hasResult() && getResult().type().isVoid();  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl returnType() {
    ...
    // Declared in ControlFlowGraph.jrag at line 526
    ...
    // Declared in ControlFlowGraph.jrag at line 527
    ...
    // Declared in ControlFlowGraph.jrag at line 528
    ...
    // Declared in Precedence.jrag at line 69
