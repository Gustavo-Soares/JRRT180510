...
public class FreshLocalVariable extends VariableDeclaration implements Cloneable, FreshVariable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public FreshLocalVariable clone() throws CloneNotSupportedException {
        FreshLocalVariable node = (FreshLocalVariable)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public FreshLocalVariable copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public FreshLocalVariable fullCopy() {
        FreshLocalVariable res = (FreshLocalVariable)copy();
    ...
    // Declared in FreshVariables.jrag at line 15
    ...
    // Declared in FreshVariables.jrag at line 47

	
	public VariableDeclaration eliminateFreshVariables() {
    ...
    // Declared in FreshVariables.jrag at line 93
    ...
    // Declared in FreshVariables.ast line 2
